...
namespace McHaleCormacProject
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void createPlayingBoard()
        {
            ...
            clearGame.Margin = new Thickness(5, 5, 5, 5);
            TextBlock instructions = new TextBlock();
            instructions.Text = "     Connect Four in a Row To Win, Tap the piece and then tap on the column you wish to add to. \n" +
                "<== Board must be reset after a Win to play again! Loser of previous round will go first in the Next.";
            instructions.Margin = new Thickness(20, 20, 20, 20);
            instructions.HorizontalAlignment = HorizontalAlignment.Center;
            changeRoot.Children.Add(clearGame);
            changeRoot.Children.Add(instructions);
        ...
        //contains logic for making player 1 move first and then player two
        ...
        {
            if (comparePiece == "ResetBoard")
            {
                //must reset the board at this point
            }
            else
            {
